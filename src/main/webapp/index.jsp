  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>EASY FINANCE</h2></a>
...
<div class="collapse navbar-collapse" id="navbarNav">
    ...
    <%if(session.getAttribute("user")== null) {%>
      <li class="nav-item active">
        <a class="nav-link" href="/Learnathon/LoginCTL">Login</a>
      </li>
       <li class="nav-item active">
        <a class="nav-link" href="/Learnathon/LoginCTL">Registration</a>
      </li>
      <%} %>
            </ul>
          </div>
    ...
    <div class="callback-form">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>We are here <em> to help!!</em></h2>
              <span>For any query please to contact us</span>
            </div>
          </div>
          <div class="col-md-12">
    ...
    <div class="sub-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p>Copyright &copy; EASY FINANCES Co., Ltd.
           </p>
          </div>
        </div>
      </div>
